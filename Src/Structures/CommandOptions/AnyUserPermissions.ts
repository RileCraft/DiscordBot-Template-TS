...
export const anyUserPermissionsFN = (client: DiscordClient, message: Message | Interaction<"cached">, command: AnyCommand): boolean => {
    ...
    if (command.anyUserPermissions.some((permission: PermissionsBitField) => message.member?.permissions.has(permission))) return true;
    else {
